...
skip_days = input("Enter the days you would want to skip, enter space for multiple days(sun mon tue wed thu fri sat): ").lower()
...
study_plan(videos, length, duration_choice, start_date, directory, skip_days)
